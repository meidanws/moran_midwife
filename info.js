let info = {
  name: "Moran Manzur",
  logo_name: "Moran ",
  flat_picture: "./src/assets/me.png",
  ...
  experience: [
    ...
    },
    {
      ...
      description:
        "creating apps and web UI, Creating Interactive prototypes, Low fidelity and UX researches",
    ...
    },
    {
      ...
      description:
        "part of team include project managers and developers to create technically feasible design, creating 95% of CRM of the company ,creating user experience and interface using adobe XD for best user solution ,finishing 80% of tasks before the target ",
  ...
  skills: [
    {
      title: "UX/UI Design",
      info: ["Figma", "Illustrator", "XD", "Photoshop"],
  ...
  courses: [
    {
      ...
      isOnline: true,
      link:
        "https://pages.greeninvoice.co.il/payments/links/3ada59ea-ec06-4bb1-a647-fd5a9c974a68?fbclid=PAAaZ2-xy2GjON7LzLJmDyUeTTsNSWza_VcIpSmDn63_tqygm61O7sB1Bg7lA",
      pictures: [
        {
          img: require("./src/assets/designs/course-icon0.jpeg"),
          title: "MoodBoard",
        },
      ],
...

    {
      ...
      pictures: [
        {
          img: require("./src/assets/designs/course-icon2.jpeg"),
          title: "MoodBoard",
        },
      ],
      technologies: ["Zoom", "Illustrator"],
      category: "Visual Design",
      github: "",
      date: "Dec, 2021",
      visit: "",
